...
LOCAL_CFLAGS := -DUSE_FFMPEG -DWITH_UPNP -DUSING_GLES2 -DZ7_CRC_NUM_TABLES=1 -DMOBILE_DEVICE -O3 -fsigned-char -Wall -Wno-multichar -Wno-unused-variable -fno-strict-aliasing -D__STDC_CONSTANT_MACROS -DSPIRV_CROSS_EXCEPTIONS_TO_ASSERTIONS -DPPSSPP_MULTICORE
...
LOCAL_C_INCLUDES := \
  ...
  $(LOCAL_PATH)/../../ext/libmgba/include \
  $(LOCAL_PATH)
