...
enum VirtKey : u32 {
	...
	VIRTKEY_GBA_FIRST = 0x40000040,
	VIRTKEY_GBA_A = 0x40000040,
	VIRTKEY_GBA_B = 0x40000041,
	VIRTKEY_GBA_START = 0x40000042,
	VIRTKEY_GBA_SELECT = 0x40000043,
	VIRTKEY_GBA_L = 0x40000044,
	VIRTKEY_GBA_R = 0x40000045,
	VIRTKEY_GBA_UP = 0x40000046,
	VIRTKEY_GBA_DOWN = 0x40000047,
	VIRTKEY_GBA_LEFT = 0x40000048,
	VIRTKEY_GBA_RIGHT = 0x40000049,
#endif
	VIRTKEY_LAST,
