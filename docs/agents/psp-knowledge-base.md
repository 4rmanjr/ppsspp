...
## Pause `SetMinimumAlpha` conditional vs unconditional
...
## System buttons (Fast-forward, Pause) tidak dibuat di GBA
...
## GBA touch button size tiny dots (preview editor)
...
## GBA gameplay touch button size hardcoded
...
## Resize range tidak match dengan semantic baru
...
## GBA portrait screen position bukan DisplayOffsetY
...
## GBATouchVisibilityPopup tidak ada button icons
...
## GBATouchVisibilityPopup save hanya di OK OnClick
