...
- [ ] **Step 1: Create `EmuCore/EmuCore.h`**
...
- [ ] **Step 2: Create `EmuCore/EmuCore.cpp`**
...
- [ ] **Step 1: Create `EmuCore/PSPCore.h`**
...
- [ ] **Step 2: Create `EmuCore/PSPCore.cpp`**
...
- [ ] **Step 1: Create `EmuCore/GBACore.h`**
...
- [ ] **Step 2: Create `EmuCore/GBACore.cpp`**
...
- [ ] **Step 1: Add mGBA as git submodule**
...
- [ ] **Step 2: Create `EmuCore/CMakeLists.txt`**
...
- [ ] **Step 3: Modify root `CMakeLists.txt` — ADD 4 lines**
...
- [ ] **Step 4: Verify build with PPSSPP_MULTICORE=ON**
...
- [ ] **Step 5: Verify build with PPSSPP_MULTICORE=OFF**
...
- [ ] **Step 1: Edit `UI/GameBrowser.cpp` line 861**
...
- [ ] **Step 1: Add detection block in `LaunchFile`**
...
- [ ] **Step 2: Add include at top of `UI/MainScreen.cpp`**
...
- [ ] **Step 4: Dual build verification**
...
- [ ] **Step 2: Edit `UI/EmuScreen.cpp` — constructor**
...
- [ ] **Step 3: Edit `UI/EmuScreen.cpp` — update() for GBA**
...
- [ ] **Step 4: Edit `UI/EmuScreen.cpp` — render() for GBA**
...
- [ ] **Step 5: Add GBA visual rendering in `renderUI()` method**
...
- [ ] **Step 6: Include necessary headers in EmuScreen.cpp**
...
- [ ] **Step 7: Dual build verification**
...
- [ ] **Step 1: Create `UI/TouchLayoutGBA.h`**
...
- [ ] **Step 2: Create `UI/TouchLayoutGBA.cpp`**
...
- [ ] **Step 3: Integrate touch layout in EmuScreen**
...
- [ ] **Step 1: Create `EmuCore/Config.h`**
...
- [ ] **Step 2: Create `EmuCore/Config.cpp`**
...
- [ ] **Step 3: Integrate config switching in EmuScreen constructor**
...
- [ ] **Step 4: Add EmuCore/Config.cpp to CMakeLists.txt**
...
- [ ] **Step 5: Dual build verification**
...
- [ ] **Step 1: Verify fork-maintenance.md has PPSSPP_MULTICORE**
...
- [ ] **Step 2: Final commit — update docs if needed**
